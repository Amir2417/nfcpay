...
@section('content')
                            ...
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td>
                                    @include('admin.components.form.switcher',[
                                        ...
                                        'onload'      => true,
                                        'data_target' =>  $item->id,
                                        'permission'  => "admin.setup.sections.security.status.update",
                                    ])
                                </td>
                                <td>
    ...
    @include('admin.components.modals.site-section.security-section.add')
    @include('admin.components.modals.site-section.security-section.edit')
    ...
    <script>
        ...
        $(".edit-modal-button").click(function(){
            ...
            $.each(languages,function(index,item) {
                ...
                editModal.find("textarea[name="+item.code+"_item_heading_edit]").val((oldData.language[item.code] == undefined) ? "" : oldData.language[item.code].item_heading);
            });
        ...
        $(document).ready(function(){
            // Switcher
            switcherAjax("{{ setRoute('admin.setup.sections.security.status.update',$slug) }}");
        })
    </script>
