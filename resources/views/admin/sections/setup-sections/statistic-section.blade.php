    ...
    <div class="table-wrapper">
        <div class="table-header justify-content-end">
            <div class="table-btn-area">
                <a href="#statistic-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
            </div>
        </div>
                ...
                <tbody>
                    @forelse ($data->value->items ?? [] as $key => $item)
                        <tr data-item="{{ json_encode($item) }}">
                            ...
                            @php
                                $statistics_value = numeric_unit_converter($item->counter_value ?? "");
                            @endphp
                            <td> {{ $statistics_value->number ?? "" }}{{ $statistics_value->unit }}</td>
                            <td>
